...
public class Driver {
	...
	public static void main(String[] args) 
		...
		System.out.println("Please specify the size"
				+ " of the Movie Theaters");
		System.out.println("\t\tEnter the information"
				+ " about the Dumbo Movie Theater:");
		...
		//element 1 is dumbo
		movies[0] = 
				new Theater(numRows, seatsInRow, "Dumbo");

		System.out.println("\t\tEnter the information "
				+ "about the Shazam! Movie Theater:");
		...
		seatsInRow = Integer.parseInt(getInput(input));
		//element 2 is shazam
		movies[1] = new Theater(numRows, seatsInRow,
				"Shazam!");

		//finally ask for price of ticket
		System.out.print("\t\t\t\t>>Enter the price "
				+ "of a ticket: ");
		PRICE_OF_TICKET = Double
		...
		System.out.println("\nSelect an operation "
				...
				"\t\t0.End the program.\n" +
				"\t\t1.Customer(s) enter(s) Movie"
					+ " Theater.\n" +
				"\t\t2.Customer buys ticket(s).\n" +
				"\t\t3.Customer(s) leave(s) the"
					+ " theater.\n" +
				"\t\t4.Display info about customers"
					+ " waiting for tickets.\n" +
				"\t\t5.Display seating chart for Shazam!"
					+ " Movie Theater.\n" +
				"\t\t6.Display seating chart for Dumbo "
					+ "Movie Theater.\n" +
				"\t\t7.Display number of tickets "
					+ "sold and total earnings.");
		//Main loop
		while (true) {
			...
			case "0":
				System.out.printf("The Wonderful Movie "
						+ "Theater earned %.02f kicks "
						+ "out remaining customers and "
						+ "closes...\nGood Bye!",
						(movies[0].getTicketsSold() 
						+ movies[1].getTicketsSold()) 
						* PRICE_OF_TICKET);
				System.exit(0);
				break;
			case "1":
			...
			case "5":
				...
				System.out.println("Here's the "
						+ "seating for the Shazam! "
						+ "Movie Theater:");
	 ...
	 * After, it checks if the customer is in
	 *  the either movie theater. Prompts
	 * repeatably until they enter a name that 
	 * is not in the movie theater.
	 * If the customer was not found, then they
	 *  will added to the appropriate
	 * line.
	 *
	 ...
	 * @throws IOException
	 */
	private static void option1(StringBuilder input, 
		...
		System.out.print(">>Is a child 11 "
				+ "or younger in this party(Y/N)? ");
		underAge = (getInput(input)
